...
| 🎬 動画 | 🎵 音声 | 🖼️ 画像 |
|:---:|:---:|:---:|
| ![動画](docs/images/shapes/shape-video.png) | ![音声](docs/images/shapes/shape-audio.png) | ![画像](docs/images/shapes/shape-image.png) |
| **720p自動変換**<br>タイムラインコメント | **波形表示**<br>シーク再生 | **ドラッグ配置**<br>リサイズ |

| 📄 テキスト | 📦 ファイル |
|:---:|:---:|
| ![テキスト](docs/images/shapes/shape-text-file.png) | ![ファイル](docs/images/shapes/shape-file-icon.png) |
| **コード補完**<br>シンタックスハイライト | **アイコン表示**<br>ダウンロード |
